    ...
    <form method="POST" wire:submit.prevent="submit">
        <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
          <div class="flex">
            ...
            <div>
              <p class="text-sm">上传节目音频注意：<br/>本页面只供提交未上传过的节目音频。如节目音频早前已上传，但需要更换，请把新的音频发到program@liangyou.net，通知中文事工办公室同工。<br/>2. 可以同时上传多个节目音频，惟不可超出音频大小上限512M。<br/>3. 节目音频格式须为64 kbps、48 kHz、mono、mp3。<br/>4. 节目音频档名须为xxxyymmdd.mp3（xxx为节目代号，yymmdd为播出日期的年年月月日日；良院或指定节目除外）。<br/>5. 节目音频和有关的节目简介，须同时提交。<br/>6. 提交节目简介后如需要修改，请发电邮到program@liangyou.net通知中文事工办公室同工。</p>
